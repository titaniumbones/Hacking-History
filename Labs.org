...
** Slack and Zotero
We use Slack for communicating, and Zotero for managing our bibliography. Both are described [[http://2017.hackinghistory.ca/other/tools/][on the Tools page]]; I justwant you to be sure to have signed up for and tried out both of them.  
...
2. Navigate to [[https://github.com/titaniumbones/mountain-please][my mountains-please repository]]
...
4. Have you found where the Mountains live?
5. Add a new mountain *from inside Github itself(!)* simply by navigating to the right spot and clicking the ~+~ button.  (see the picture below)
...
6. File a pull request with me by navigating back to the main page of your repository (~github.com/your-user-name/mountains-please/) and hitting the Github pull request button: [[./Images/github-pull-request.png]]
...
- then a series of *property-value pairs*.  Each of these sets the /value/ of a particular /property/ (duh).  Note that at the end of a property statement, there is *always* a semi-colon, and that the property and value are separated by a colon!  
...
- *Class* selectors:  these give the name of a class attribute that an HTML element may have.  These selectors will always begin with a period (".").  So for instance:
#+BEGIN_SRC html
...
* Lab 06: Wordpress & Wordpress Themes
:PROPERTIES:
:ID:       o2b:00873ce5-90ca-4c97-aa2b-d58be4609329
:PARENT:   10
:POST_DATE: [2016-11-29 Tue 09:53]
:POSTID:   239
:EXPORT_FILE_NAME: lab-wordpress-and-wordpress-themes
:END:
...
This is the main "loop" that the theme uses for pages.  Where should it go in your file? And what happens when you use it? 
...
-----
* COMMENT Lab 07: Theming with Wordpress [DEPRECATED -- See Wordpress, above]
:PROPERTIES:
...
** COMMENT Commemorating Vimy Ridge
:PROPERTIES:
:EXPORT_FILE_NAME:
:END:
