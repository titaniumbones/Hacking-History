...
- *do not design your own web framework.*  Instead, you should use [[http://www.wordpress.org][Wordpress]] or in rare cases the partnering organization's existing web technologies.  If you have a prior expertise in some other framework or in web design, you should discuss this with me immediately.
